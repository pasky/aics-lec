all: lec1.pdf lec2.pdf lec3.pdf lec4.pdf lec5.pdf lec6.pdf lec7.pdf lec8.pdf lec9.pdf lecA.pdf
...
clean:
	rm -f lec[123456789A].{aux,dvi,log,nav,out,pdf,snm,toc} sigmoid.pdf
